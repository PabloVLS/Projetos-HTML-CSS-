...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-9">
                <h3 class="mt-3">Listagem de livros</h3>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="editarLivros.php?id=<?php echo $item->id; ?>" class="btn btn-sm btn-warning" data-bs-toggle="tooltip" 
                                data-bs-placement="top" data-bs-title="Editar Livros">
