...
<head>
    ...
    <title>DW1 - Adicionar Atividade</title>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-9">
                ...
                <form action="addAtividade.php" method="post">
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-3">
                            ...
                            <input type="date" class="form-control" id="id-data" name="campo-data" value="" required maxlength="11" >
                        </div>
                        <div class="col-lg-4 mb-3">
