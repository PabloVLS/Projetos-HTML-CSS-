...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-9">
                <h3 class="mt-3">Adicionar Noticias</h3>
                <form action="addNoticias.php" method="post">
                    <div class="row">
                        ...
                        <div class="col-lg-4 mb-3">
                            ...
                            <input type="text" class="form-control" id="id-categoria" name="campo-categoria" value="" required>
                        </div>
                        <div class="col-lg-8 mb-3">
                            <label for="id-texto" class="form-label">Texto:</label>
                            <textarea class="form-control" id="id-texto" rows="3" name="campo-texto"></textarea>
                        </div>
                        <div class="col-12">
                            <button class="btn btn-success" type="submit">Salvar Noticia</button>
                        </div>
                    </div>
                </form>
            </div>
